    ...
    public static class Views_Administrador
    {
        public static async Task Display_Adm_Contas()
        {
            ...
            while (!sair)
            {
                ...
                Console.WriteLine(" |- Deletar Conta Existente . . . . . . . . |  3  |           ▐  ▐▄▌       ▐▄▌  ▌ Hmmmmmm..  ");
        ...
        public static async Task Display_Adm_Jogador()
        {
            ...
            while (!sair)
            {
                ...
                Console.WriteLine(" |- Deletar Informações de Jogador  . . . . |  3  |           ▐  ▐▄▌       ▐▄▌  ▌ Hmmmmmm..  ");
                Console.WriteLine(" |__________________________________________|_____|        .  ▐   ▀   ▄▄▄   ▀   ▌          . ");
                Console.WriteLine(" |- SAIR  . . . . . . . . . . . . . . . . . |  0  |     .      █    ▄ ▀█▀ ▄    █ .      .    ");
                Console.WriteLine(" |================================================|          .  ▀▄   ▀▀ ▀▀   ▄▀              ");
                Console.WriteLine("    .             .          .               .      .            ▐▀▄▄▄   ▄▄▄▀▌       .     . ");
        ...
        public static async Task Display_Adm_Tecnico()
        {
            ...
            while (!sair)
            {
                ...
                Console.WriteLine(" |- Deletar Informações de Tecnico  . . . . |  3  |           ▐  ▐▄▌       ▐▄▌  ▌ Hmmmmmm..  ");
                Console.WriteLine(" |__________________________________________|_____|   .       ▐   ▀   ▄▄▄   ▀   ▌     .      ");
                Console.WriteLine(" |- SAIR  . . . . . . . . . . . . . . . . . |  0  |            █    ▄ ▀█▀ ▄    █           . ");
                Console.WriteLine(" |================================================|        .    ▀▄   ▀▀ ▀▀   ▄▀  .     .     ");
                Console.WriteLine("            .                        .                           ▐▀▄▄▄   ▄▄▄▀▌            .  ");
        ...
        public static async Task Display_Adm_Times()
        {
            ...
            while (!sair)
            {
                ...
                Console.WriteLine(" |- Deletar Informações de Times  . . . . . |  3  |           ▐  ▐▄▌       ▐▄▌  ▌ Hmmmmmm..  ");
                Console.WriteLine(" |__________________________________________|_____|           ▐   ▀   ▄▄▄   ▀   ▌            ");
                Console.WriteLine(" |- SAIR  . . . . . . . . . . . . . . . . . |  0  |   .        █    ▄ ▀█▀ ▄    █         .   ");
                Console.WriteLine(" |================================================|         .   ▀▄   ▀▀ ▀▀   ▄▀    .         ");
                Console.WriteLine("        .               .                   .       .            ▐▀▄▄▄   ▄▄▄▀▌               ");
        ...
        public static async Task Display_Adm_Jogos()
        {
            ...
            while (!sair)
            {
                ...
                Console.WriteLine(" |- Deletar Informações de Jogos  . . . . . |  3  |           ▐  ▐▄▌       ▐▄▌  ▌ Hmmmmmm..  ");
                Console.WriteLine(" |__________________________________________|_____|           ▐   ▀   ▄▄▄   ▀   ▌            ");
                Console.WriteLine(" |- SAIR  . . . . . . . . . . . . . . . . . |  0  |            █    ▄ ▀█▀ ▄    █      .      ");
                Console.WriteLine(" |================================================|      .      ▀▄   ▀▀ ▀▀   ▄▀              ");
                Console.WriteLine("            .            .                  .                    ▐▀▄▄▄   ▄▄▄▀▌  .            ");
        ...
        public static async Task Display_Adm_Partidas()
        {
            ...
            while (!sair)
            {
                ...
                Console.WriteLine(" |- Deletar Informações de Partidas . . . . |  3  |           ▐  ▐▄▌       ▐▄▌  ▌ Hmmmmmm..  ");
